...
class InternetAccessController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'approver_email.required'       => 'Recommender Email is required.',
            'approver_email.email'          => 'Please enter a valid recommender email.',
            'approver_name.required'        => 'Recommender details could not be fetched. Please verify the recommender email.',
            'approver_designation.required' => 'Recommender designation could not be fetched.',
            'approver_department.required'  => 'Recommender department could not be fetched.',
